...
@Component({
  ...
  styleUrl: './example-tel-input.component.css',

  providers: [
    { provide: MatFormFieldControl, useExisting: ExampleTelInputComponent },
  ],
  host: {
...
export class ExampleTelInputComponent
  implements ControlValueAccessor, MatFormFieldControl<MyTel>, OnDestroy
{
  ...
  readonly id = `example-tel-input-${ExampleTelInputComponent.nextId++}`;
